# Bake-time finalize for Server 2025. Disables Windows Update so cloned
# VMs don't re-pull patches on first boot. Same pattern as the 2022 +
# 2019 finalize scripts.
