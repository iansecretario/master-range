# Bake-time baseline for Windows Server 2025.
# Same shape as win-server-2022-baseline.ps1 — AD-DS + DNS roles
# (NOT promoted), RDP + WinRM open, NIC categorization Private.
