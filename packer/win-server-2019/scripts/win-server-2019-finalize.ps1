# Bake-time finalize for Server 2019. Runs AFTER Windows Update so the
# image ships with the latest cumulative patches but won't re-run WU on
# every cloned VM. Identical pattern to win-server-2022-finalize.ps1.
