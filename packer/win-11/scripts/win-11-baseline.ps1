# Bake-time baseline for Windows 11 workstation image. Same posture as
# win-10-baseline.ps1; kept separate file for clarity should we ever
# need 11-specific tweaks (Win11 has TPM/Secure Boot quirks).
